 ...
 * Modificado por: Gari Arellano Zubía (funciones establecidas en la práctica 3)
...
/*
 *  Pre: a ≠ 0 o b ≠ 0
 *  Post: Ha devuelto el minimo común multiplo de <a> y <b>.
 */
...
/*
 *  Pre: n ≠ 0
 *  Post: Ha devuelto true si n es capicua y un false si n NO es capicua.
 */
